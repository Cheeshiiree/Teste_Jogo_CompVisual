...
while True:
    ...
    # Ver se consegue colocar o codigo num pop-up window para facilitar a visualização e o acesso ao código, e para tornar a experiência mais imersiva e interativa, permitindo que o usuário possa ver o código em tempo real enquanto testa os filtros e as transformações, e talvez até editar o código diretamente para criar seus próprios filtros personalizados ou modificar os existentes, para ter um controle total sobre o laboratório e suas possibilidades de experimentação.
    # ---------------------------------------------------------
